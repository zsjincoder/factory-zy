		...
		methods:{
			init:function(list){			
				if (list.type == 'success') {
					list.icon = '/static/img/xuan-popup/success.png';
					list.typeClass='mpopup-success';
					return list;
				}
				if (list.type == 'warn') {
					list.icon = '/static/img/xuan-popup/warn.png';
					list.typeClass='mpopup-warn';
					return list;
				}
				if (list.type == 'info') {
					list.icon = '/static/img/xuan-popup/info.png';
					list.typeClass='mpopup-info';
					return list;
				}
				if (list.type == 'err') {
					list.icon = '/static/img/xuan-popup/err.png';
					list.typeClass='mpopup-err';
					return list;
				}
				if (list.type == 'loading') {
					list.icon = '/static/img/xuan-popup/loading.png';
